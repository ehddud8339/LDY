...
if [ ${storage} == ramdisk ]; then
    ...
    make
    sleep 1
    strace -e read,write -f -o ./StackFS_ll -r /mnt/RFUSE_EXT4 /mnt/test &
    popd
...
#YCSB _ start
#pushd ../../../YCSB
#sudo ./load_workload.sh ${scrtype} 40000000 40000000 ${scheduler}_${scrtype}
#echo -e "\n\n\nWaiting for 60 sec after YCSB load files sync... \n\n\n"
#sleep 60

##YCSB Log dmesg -1 _ start
#bash /home/ldy/rfuse/bench/custom/dmesg_log.sh ${scrtype} ${scheduler} &
#bg_pid=$!
##YCSB Log dmesg -1 _ end

#sudo ./run_workload.sh ${scrtype} 40000000 40000000 ${scheduler}_${scrtype}
